...
const publications = [
    { title: 'Deposition Outline: The Examination of the Expert on Damages', image: '/images/future-lost-profits.png' },
];

export default function DepositionOutlinePublications() {
