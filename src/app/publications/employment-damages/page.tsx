...
const publications = [
    { title: 'The Measurement of Employment Damages: Personal Injury & Wrongful Death Litigation', image: '/images/future-lost-profits.png' },
];

export default function EmploymentDamagesPublications() {
