...
const publications = [
    { title: 'Framework for the Calculation of Infringement Damages: Part I: "Trademark Infringement Damages Under the Lanham Act"', image: '/images/future-lost-profits.png' },
    { title: 'Framework for the Calculation of Infringement Damages: Part II "Patent Infringement Damages"', image: '/images/future-lost-profits.png' },
];

export default function InfringementDamagesPublications() {
