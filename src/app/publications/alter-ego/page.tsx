...
const publications = [
    { title: 'The Framework for an Alter Ego Analysis: Part I', image: '/images/future-lost-profits.png' },
    { title: 'The Framework for an Alter Ego Analysis: Part II', image: '/images/future-lost-profits.png' },
];

export default function AlterEgoPublications() {
