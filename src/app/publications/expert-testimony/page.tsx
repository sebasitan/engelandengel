...
const publications = [
    { title: 'The Measurement of Damages: "Expert Testimony & The Qualification of the Expert"', image: '/images/future-lost-profits.png' },
    { title: 'The Measurement of Damages: "Expert Testimony & Professional Standards"', image: '/images/future-lost-profits.png' },
    { title: 'The Measurement of Damages: "Expert Testimony & Foundations"', image: '/images/future-lost-profits.png' },
];

export default function ExpertTestimonyPublications() {
