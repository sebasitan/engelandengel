...
const sections = [
  {
    ...
    title: 'Overview',
    paragraphs: [
      'Intellectual property litigation often demands the expertise of a forensic accountant in evaluating infringement damages. Engel & Engel has extensive experience in conducting forensic investigations and providing expert testimony in connection with intellectual property matters for both plaintiffs and defendants. When patents, copyrights, trademarks, trade secrets, and unfair business practices are litigated, Engel & Engel works with counsel to prepare sound analyses that are consistent with financial principles articulated by the courts. Our IP litigation experience is highlighted with a $2.3 billion jury award in connection with the misappropriation of trade secrets. Our expertise in intellectual property further includes two research publications on the subjects of trademark and patent infringement damages. Overall, Engel & Engel has the qualifications and experience to prepare infringement damage analyses that are consistent with established legal principles and are able to withstand the scrutiny of the court.',
    ],
    subheading: '',
    items: [],
  },
  ...
  },
  {
    ...
    title: 'Publications',
    paragraphs: [
      'Engel & Engel has published the following research publications in connection with Intellectual Property under the Lanham Act:',
    ],
    subheading: '',
    items: [
...
const stats = [
  { value: '$2.3B', label: 'Jury Award — Trade Secret Case' },
  { value: '2', label: 'IP Research Publications' },
          ...
          <div className="container-custom relative z-10">
            ...
            >
              <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tighter text-white">
                ...
                <span className="font-serif italic text-[#D4AF37] font-medium text-[2.5rem]">(IP) Litigation</span>
              </h1>
            </motion.div>
          </div>
        </section>
