...
const sections = [
  ...
  },
  {
    ...
    title: 'Services',
    paragraphs: [
      'How Engel & Engel Helps Litigation Attorneys in Business Interruption Claims',
          ...
          <div className="container-custom relative z-10">
            ...
            >
              <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tighter text-white">
                Business <br />
                <span className="font-serif italic text-[#D4AF37] font-medium text-[2.5rem]">Interruption</span>
              </h1>
            </motion.div>
          </div>
        </section>
