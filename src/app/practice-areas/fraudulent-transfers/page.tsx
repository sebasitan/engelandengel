...
const stats = [
  { value: 'CIRA', label: 'Certified Insolvency & Restructuring Advisor' },
  { value: '4', label: 'Fraudulent Transfer Publications' },
  { value: 'CFE', label: 'Certified Fraud Examiners' },
];
          ...
          <div className="container-custom relative z-10">
            ...
            >
              <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tighter text-white">
                Fraudulent <br />
                <span className="font-serif italic text-[#D4AF37] font-medium text-[2.5rem]">Transfers</span>
              </h1>
            </motion.div>
          </div>
        </section>
