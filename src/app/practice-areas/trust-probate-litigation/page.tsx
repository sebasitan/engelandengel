...
const sections = [
  {
    ...
    title: 'Overview',
    paragraphs: [
      'Trust, estate, and probate disputes often arise from poor recordkeeping, lack of transparency, or intentional misconduct. Questions surrounding the management of trust assets, valuation of estates, and accuracy of accounting can quickly escalate into litigation when beneficiaries suspect mismanagement or fraud.',
      'At Engel & Engel, LLP, we work closely with attorneys to untangle complex financial records, trace assets, and provide the forensic accounting analysis necessary to resolve these disputes. Our team brings clarity and precision to cases where the truth is hidden within years of financial activity.',
      'With decades of experience in forensic accounting, Engel & Engel provides the financial expertise needed to investigate trust and estate disputes, evaluate claims, calculate damages, and deliver findings that withstand scrutiny in court.',
    ],
    subheading: '',
    items: [],
  },
  {
    ...
    title: 'Services',
    paragraphs: [
      'How Engel & Engel Helps Trust/Probate Attorneys',
