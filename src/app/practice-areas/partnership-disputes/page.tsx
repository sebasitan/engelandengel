...
const sections = [
  {
    ...
    title: 'Overview',
    paragraphs: [
      'Business litigators often require the expertise of a forensic accountant when evaluating financial issues in connection with partnership and shareholder disputes. Engel & Engel has extensive experience in conducting forensic investigations and providing expert testimony for both plaintiffs and defendants. Engel & Engel has been involved in over 100 cases regarding corporate and partnership disputes including dissolutions under California Corporations Code Section 2000. Overall, Engel & Engel has the qualifications and experience to investigate partnership/shareholder disputes and prepare analyses consistent with established financial principles that can withstand the scrutiny of the court.',
    ],
    subheading: '',
    items: [],
  },
  {
    ...
    title: 'Services',
    paragraphs: [
      'How Engel & Engel Helps Litigators in Partnership/Shareholder Disputes',
...
const stats = [
  { value: '100+', label: 'Corporate & Partnership Dispute Cases' },
  { value: 'CC §2000', label: 'California Corporations Code Expertise' },
          ...
          <div className="container-custom relative z-10">
            ...
            >
              <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tighter text-white">
                Partnership / <br />
                <span className="font-serif italic text-[#D4AF37] font-medium text-[2.5rem]">Shareholder Disputes</span>
              </h1>
            </motion.div>
          </div>
        </section>
