...
const sections = [
  ...
  },
  {
    ...
    title: 'Services',
    paragraphs: [
      'How Engel & Engel Helps Attorneys in Accounting Malpractice Matters',
...
const stats = [
  { value: 'GAAP', label: 'Generally Accepted Accounting Principles' },
  { value: 'GAAS', label: 'Generally Accepted Auditing Standards' },
          ...
          <div className="container-custom relative z-10">
            ...
            >
              <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tighter text-white">
                Accounting <br />
                <span className="font-serif italic text-[#D4AF37] font-medium text-[2.5rem]">Malpractice</span>
              </h1>
            </motion.div>
          </div>
        </section>
