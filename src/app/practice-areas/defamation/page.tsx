...
const sections = [
  {
    ...
    title: 'Overview',
    paragraphs: [
      'Defamation, whether directed at an individual, public figure, or company, can result in serious reputational and financial harm. False or misleading statements in the press, on social media, or within a professional industry may lead to lost revenue, diminished career opportunities, or long-term damage to brand value. At the same time, not all alleged damages can be attributed to the defamation, and a careful financial review is often essential in mounting a strong defense.',
      'At Engel & Engel, LLP, we provide forensic accounting expertise in defamation litigation for both plaintiffs and defendants. Our role is to bring clarity to complex financial issues, examining whether reputational harm has translated into measurable losses. We deliver thorough and defensible analyses, prepared with the rigor required to withstand the scrutiny of the court in defamation claims. With decades of experience in forensic accounting, Engel & Engel, LLP provides the credibility and financial expertise required to evaluate claims of reputational harm and deliver analyses that withstand scrutiny in court.',
    ],
    subheading: '',
    items: [],
  },
  {
    ...
    title: 'Services',
    paragraphs: [
      'How Engel & Engel Helps Attorneys Litigating Defamation Claims',
      'We assist attorneys in both pursuing and defending claims of economic harm caused by alleged defamation. Our work includes:',
    ],
    subheading: '',
    items: [
      'Causation Analysis',
      'Revenue and Earnings Impact',
      'Celebrity and Public Figure Damages',
...
export default function DefamationLitigationPage() {
